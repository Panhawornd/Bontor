  ...
  return (
    <div className="min-h-screen text-white flex flex-col items-center justify-center p-6 relative">
      ...
      <div className="text-center">
        <BarChart3 className="w-24 h-24 text-blue-500 mx-auto mb-8 animate-bounce" />
        <h1 className="text-5xl font-bold mb-4">Dashboard</h1>
        <p className="text-xl text-gray-400 mb-8">This page is coming soon! We&apos;re working hard to bring you comprehensive analytics and insights.</p>
        <Button
