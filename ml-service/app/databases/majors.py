...
MAJOR_DATABASE = {
    "Computer Science": {
        "keywords": ["computer science", "programming", "coding", "software development", "software engineering", "algorithm", "data structures", " ai ", "machine learning", "software engineer", "programmer", "backend", "frontend", " api ", "database", "app development", "web development", "mobile development", "code", "developer"],
    ...
    "Data Science": {
        "keywords": ["data science", "data analytics", "statistics", "python", " r ", "data analyst", "data scientist", "big data", "data mining", "predictive", "data visualization", "sql", "quantitative"],
        "required_subjects": ["math", "physics"],
    ...
    "Architecture": {
        "keywords": ["architecture", "architect", "architectural", "architectural design", "building design", "building", "sustainable", "urban planning", "landscape", "cad", "blueprint", "structures", "floor plan", "residential", "commercial", "spatial design"],
        "required_subjects": ["math", "physics"],
    ...
    "UX/UI Design": {
        "keywords": ["ux", "ui", "ux design", "ui design", "user experience", "user interface", "wireframe", "prototype", "figma", "adobe xd", "sketch", "usability", "interaction design", "ux designer", "ui designer", "product designer", "user research", "user testing", "design thinking", "web interface", "interface design", "digital interface", "app interface", "website design", "web design", "mobile interface", "designing interface", "interface designer", "web designer", "digital designer", "interface", "designing web", "web ui", "web ux", "digital experience", "user-centered design", "human-computer interaction", "hci", "design system", "responsive design", "frontend design"],
        "required_subjects": ["english", "math"],
